    ...
    <div class="col-md-3">
        <div class="panel panel-default">
            <div class="panel-body">
                <div align="center">
                    <img src="%user_avatar%" class="img-thumbnail" style="width:50%;"><br />
                    <a href="%profile_url%" >%username%</a><br />
        <small class="text-muted">Joined:</small> <small>%date_joined%</small><br />
                            <small class="text-muted">Messages:</small> <small>%postcount%</small>
                </div>
...
<div class="panel panel-default" style="max-width:70%;margin:0 auto;">
    <div class="panel-body">
        <form action="" method="POST" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="%username_field_name%" id="username">
                </div>
            </div>
            <div class="form-group">
                <label for="password" class="col-sm-2 control-label">Password</label>
                <div class="col-sm-10">
                    <input type="password" class="form-control" name="%password_field_name%" id="password">
                </div>
            </div>
            <div class="form-group">
                <label for="a_password" class="col-sm-2 control-label">Confirm Password</label>
                <div class="col-sm-10">
                    <input type="password" class="form-control" name="%password_a_field_name%" id="a_password">
                </div>
            </div>
            <div class="form-group">
                <label for="email" class="col-sm-2 control-label">Email</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="%email_field_name%" id="email">
                </div>
            </div>
            <div class="form-group">
                <label for="tangobb_captcha" class="col-sm-2 control-label">Are you a bot?</label>
                <div class="col-sm-10">
                    %captcha%
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-3 text-right">
                    <input type="submit" class="btn btn-default btn-block" name="%submit_name%" value="Register" class="btn btn-default" />
                </div>
            </div>
        </form>
    </div>
...
<div class="panel panel-default" style="max-width:70%;margin:0 auto;">
    <div class="panel-body">
        <form action="" method="POST" class="form-horizontal" role="form">
            <div class="form-group">
                <label for="email" class="col-sm-2 control-label">Username or Email</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="%email_field_name%" id="email">
                </div>
            </div>
            <div class="form-group">
                <label for="password" class="col-sm-2 control-label">Password</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="%password_field_name%" id="password">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="submit" name="%submit_field_name%" value="Sign In" class="btn btn-default btn-block" />
                </div>
            </div>
        </form>
    </div>
...
<div class="panel panel-default" style="max-width:70%;margin:0 auto;">
    <div class="panel-body">
        <form action="" method="POST" id="tango_form" class="form-horizontal" role="form">
            %csrf_field%
            <div class="form-group">
                <label for="email" class="col-sm-2 control-label">Email</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="%email_field_name%" id="email" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-offset-9 col-sm-3">
                    <input type="submit" name="%submit_field_name%" value="Send Email" class="btn btn-default btn-block" />
                </div>
            </div>
        </form>
    </div>
