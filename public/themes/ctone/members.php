...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="%site_url%/public/themes/ctone/assets/css/codetana.css" rel="stylesheet">
  ...
  <body>
          ...
          <div class="collapse navbar-collapse" id="main-nav">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown search-toggle">
                ...
                <ul class="dropdown-menu">
                  <li><form action="%site_url%/search.php" method="POST" class="search">
          ...
          <div class="col-md-3">
            <div class="panel panel-default">
              <div class="panel-body">
                ...
                @else
                <a href="%site_url%/members.php/cmd/register" class="btn btn-primary btn-block btn-lg">Register</a>
                @endif
              </div>
            </div>
    ...
    %highlighter_footer%
    <script src="%site_url%/public/themes/ctone/assets/js/bootstrap.min.js"></script>
    <script src="%site_url%/public/themes/ctone/assets/js/ct.js"></script>
    <script>
