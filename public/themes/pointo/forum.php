...
<html>
  ...
  <body>
    ...
    <div id="wrapper" class="container">
        ...
        <div class="row">
            <div class="col-md-12">
              <div class="jumbotron intro" id="intro">
                <div class="ss"></div>
                <h1 class="header">Introducing TangoBB 1.1</h1>
                <p class="tag">
                  Simple, customizable and open source.<br />
                  <a href="https://github.com/TangoBB/TangoBB" class="btn btn-default" style="margin-top:10px;" target="_blank"><i class="fa fa-github-alt"></i> Github</a>
                  <a href="http://library.tangobb.net/dl/TangoBB_1.1.2.zip" class="btn btn-default" style="margin-top:10px;"><i class="glyphicon glyphicon-download"></i> Download (1.1.2)</a>
                </p>
              </div>
            </div>
            <div class="col-md-9">
