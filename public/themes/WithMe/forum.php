  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="wrap">
        ...
        <div class="header">
            <h1 class="pull-left">%site_name%</h1>
            <div class="pull-right">
                ...
                <div class=" btn-group user_links">
                    <a href="%site_url%/mod" class="btn btn-info btn-lg"><i class="glyphicon glyphicon-flag"></i> <span class="label label-danger">%mod_report_integer%</span></a>
                </div>
                @endif
                @if ($TANGO->perm->check('access_administration'))
                <div class=" btn-group user_links">
                    <a href="%site_url%/admin" class="btn btn-danger btn-lg"><i class="glyphicon glyphicon-tower"></i></a>
                </div>
                @endif
                @else
