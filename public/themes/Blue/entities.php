...
<div class="panel panel-default">
    <div class="panel-heading"><b>%category_name%</b><br/>
...
<tr>
    <td><img src="%user_avatar%" class="img-thumbnail pull-left" style="width:42;height:42px;margin-right:5px;"/>%thread_name%<span
            class="label label-info pull-right">%status%</span><br/>
