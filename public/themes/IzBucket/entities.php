...
<div class="row">
    ...
    <div class="col-md-10">
        <div class="panel panel-default">
            <div class="panel-body panel-thread">
...
<div id="reply">
    <form id="%form_id%" action="%reply_form_action%" method="POST">
        ...
        <p class="pull-right" style="margin-top:5px;">
            <input type="submit" name="%submit_name%" value="Post Reply" class="btn btn-default" />
        </p>
    </form>
</div>
<!--- tpl:reply_thread:end -->
<!--- tpl:forum_listings_category:start -->
<div class="alert alert-forum">
...
<tr>
    <td style="width:70%;">
        <span class="toggle_tooltip" data-toggle="tooltip" title="%node_desc%" data-placement="right">%node_name%</span><br />
...
<form id="%form_id%" action="%create_thread_form_action%" method="POST">
    ...
    <div class="center-block" style="margin-top:5px;">
        <input type="submit" name="%submit_name%" value="Create Thread" class="btn btn-default" />
    </div>
</form>
...
<form id="%form_id%" action="%create_thread_form_action%" method="POST">
    ...
    <textarea id="%editor_id%" style="width:100%;height:300px;max-width:100%;" name="%textarea_name%"></textarea>
    <div class="center-block" style="margin-top:5px;">
        <input type="submit" name="%submit_name%" value="Reply Thread" class="btn btn-default" />
