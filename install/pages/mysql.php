...
if (isset($_POST['submit'])) {
    try {
        ...
        if (!$mysql_host or !$mysql_username or !$mysql_database or !$mysql_prefix) {//Check if all values are there.
            ...
            $MYSQL->query("CREATE TABLE IF NOT EXISTS `" . $mysql_prefix . "user_comments` (`id` int(11) NOT NULL AUTO_INCREMENT, `profile_owner` int(11) NOT NULL, `writer` int(11) NOT NULL, `comment` text NOT NULL, `timestamp` int(11) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=14 ;");
            $MYSQL->query("CREATE TABLE IF NOT EXISTS `" . $mysql_prefix . "user_visitors` (`id` int(11) NOT NULL AUTO_INCREMENT,`profile_owner` int(11) NOT NULL,`visitor` int(11) NOT NULL,`timestamp` int(11) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=14 ;");
