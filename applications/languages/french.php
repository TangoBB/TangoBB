<?php
  ...
  $LANG = array(
    ...
    'bb' => array(
      ...
      'members' => 'Membres',
      'search' => 'Recherche',
      'edit_post_in' => 'Modifier poste dans:',
      'new_thread_in' => 'Nouveau fil en:',
      'new_reply_in' => 'Nouvelle réponse en:',
      'new_report' => 'Rapport',
      'new_thread_breadcrumb' => 'Nouveau fil',
      'edit_post_breadcrumb' => 'Modifier poste',
      'new_reply_breadcrumb' => 'Nouvelle réponse',
      'already_watched_thread' => 'Vous êtes déjà en train de regarder ce fil.',
      'already_unwatched_thread' => 'Vous êtes déjà ne regardez pas ce fil.',
      'watch_thread' => 'Vous êtes en train de regarder ce fil.',
      'unwatch_thread' => 'Vous êtes maintenant ne regardez pas ce fil.',
      'error_watching' => 'Erreur fil regarder.',
      'error_unwatching' => 'Fil de Fin du suivi d'erreur.',
      'form' => array(
      ...
      'conversations' => array(
            ...
            'page_new' => 'Commencer la conversation',
            'page_reply' => 'Répondre la conversation:',
            'starter' => 'Commencer par',
            'reciever' => 'Envoyé à',
            'by' => 'By:', // not needed anymore
        'for' => 'For:', // not needed anymore
        'form_to'=> 'à <small>Séparés par un ","</small>',
        'form_send' => 'Envoyer',
        'form_title' => 'Titre',
        'form_reply' => 'Répondre',
        'no_conversations' => 'Pas encore de conversations.',
        'user_not_exist' => 'Utilisateur <strong>%username%</strong> n'existe pas!',
        'message_sent' => 'Votre message <strong>%username%</strong> a été envoyé!',
        'error_sending' => 'Erreur d'envoi d'un message à <strong>%username%</strong>.',s
        'error_sending_alt' => 'Erreur d'envoi message.'
      ), // Left off here
      'members' => array(
        'home' => 'Members',
