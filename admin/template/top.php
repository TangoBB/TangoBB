    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a
                        href="javascript:return false;">Welcome,  <?php echo $TANGO->sess->data['username']; ?></a></li>
                <li><a href="<?php echo SITE_URL; ?>/admin"><i class="glyphicon glyphicon-dashboard"></i> Dashboard</a>
                </li>
                <li><a href="<?php echo SITE_URL; ?>/admin/terminal.php"><i class="fa fa-terminal"></i> Terminal</a>
                </li>
                <?php echo $ADMIN->navigation(); ?>
            </ul>
            <div align="center" class="options" id="tooltip">
                <a href="<?php echo SITE_URL; ?>" class="btn btn-default btn-lg" data-toggle="tooltip"
                   title="Back To Forum">
                    <i class="glyphicon glyphicon-log-out"></i>
                </a>
                <a href="<?php echo SITE_URL; ?>/members.php/cmd/logout" class="btn btn-default btn-lg"
